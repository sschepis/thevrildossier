...
MKUltra's documented interest in electromagnetic effects on consciousness — particularly Subproject 119, which studied techniques for "activating the human organism by remote electronic means" — represents, under the EM ecology model, an institutional attempt to reverse-engineer the coupling mechanism that EM entities employ naturally. The classified program was, in this reading, not merely exploring mind control in the abstract but probing the specific electromagnetic interface through which non-biological intelligences interact with human neurology.
